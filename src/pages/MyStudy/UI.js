...
export const Profile = ({ studyId, studyname, isAdmin, isOffline }) => (
  <>
    ...
    <div className="flex items-center justify-start my-4 space-x-4">
      ...
      {isOffline == "N" ? (
        <span className="px-2 py-1 flex items-center text-xs rounded-md font-semibold text-blue-500 bg-blue-50">
          ONLINE
        </span>
      ) : (
        <span className="px-2 py-1 flex items-center text-xs rounded-md font-semibold text-blue-500 bg-blue-50">
...
export const AddButton = ({ onClickButton }) => (
  <button
    className="p-0 w-10 h-10 bg-blue-500 rounded-full hover:bg-blue-500 active:shadow-lg mouse shadow transition ease-in duration-200 focus:outline-none"
